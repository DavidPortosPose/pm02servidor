...
CREATE OR ALTER PROCEDURE PUB_USUARIO_EMPRESA_S(PATRON T_APELLIDOS, ID_EMPRESA_B T_ID)
RETURNS(
...
BEGIN
FOR
    SELECT ID_USUARIO_EMPRESA, ID_EMPRESA, ID_USUARIO, NOMBRE, APELLIDOS, NIF, ACTIVO, DIR
    FROM USUARIO_EMPRESA UE
    WHERE UE.ID_EMPRESA =: ID_EMPRESA_B AND UE.APELLIDOS CONTAINING :PATRON
    INTO :ID_USUARIO_EMPRESA, :ID_EMPRESA, : ID_USUARIO, :NOMBRE, :APELLIDOS, :NIF, :ACTIVO, :DIR
DO SUSPEND; 
    

END^

CREATE OR ALTER PROCEDURE PUB_USUARIO_EMPRESA_S_ID(ID_USUARIO_EMPRESA_B T_ID)
RETURNS(
ID_USUARIO_EMPRESA T_ID,
ID_EMPRESA T_ID,
ID_USUARIO T_ID,
...
BEGIN
    ...
    INSERT INTO USUARIO_EMPRESA (ID_USUARIO_EMPRESA,ID_EMPRESA,ID_USUARIO,NOMBRE,APELLIDOS, NIF, ACTIVO, DIR)
    VALUES (:ID_USUARIO_EMPRESA, :ID_EMPRESA, :ID_USUARIO, :NOMBRE, :APELLIDOS, :NIF, 'S', :DIR);
    OK = 'S';
    SUSPEND;
